...
public sealed partial class ClassicZLevelBlurOverlay : Overlay
{
    ...
    private readonly ProtoId<ShaderPrototype> _zBlurShader = "ClassicZBlur";

    public ClassicZLevelBlurOverlay()
    {
