...
namespace Content.Client._Classic.Salvage.Fulton;
...
public sealed partial class ClassicCargoFultonSystem : SharedClassicCargoFultonSystem
{
    ...
    private static readonly Animation InitialAnimation = new()
    {
        ...
        AnimationTracks =
        {
            ...
            {
                LayerKey = BaseFultonSystem.FultonVisualLayers.Base,
                KeyFrames =
                {
    ...
    protected override void UpdateAppearance(EntityUid uid, ClassicFultonSoldComponent component)
    {
        ...
        _player.Play(component.Effect, InitialAnimation, "classic-fulton");
    }
}
