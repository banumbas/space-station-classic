...
using Content.Client._Classic.ZCollapse;
...
namespace Content.Client._Classic.ZCollapse.Overlays;

/// <summary>
/// Renders the ZCollapse stability snapshot cached by <see cref="ClassicZCollapseClientSystem"/>: a
...
/// </summary>
public sealed partial class ClassicZCollapseDebugOverlay : Overlay
{
    ...
    private readonly ClassicZCollapseClientSystem _collapse;
    ...
    public ClassicZCollapseDebugOverlay()
    {
        IoCManager.InjectDependencies(this);

        _collapse = _entityManager.System<ClassicZCollapseClientSystem>();
