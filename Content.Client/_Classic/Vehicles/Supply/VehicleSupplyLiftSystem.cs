...
namespace Content.Client._Classic.Vehicles.Supply;
...
public sealed class VehicleSupplyLiftSystem : EntitySystem
{
    ...
    private const string AnimationKey = "vehicle_supply_lift";
    private const string BaseLayerKey = "vehicle-supply-lift-base";
