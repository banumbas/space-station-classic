...
///
/// Geometry model: each network designates one <see cref="ClassicZGridNetworkComponent.AnchorGrid"/>
/// (static planet if present, otherwise the lowest <see cref="EntityUid"/> for determinism). Every
/// other grid stores its pose as <see cref="ClassicZGridComponent.NetworkOffset"/>/
/// <see cref="ClassicZGridComponent.NetworkRotation"/> relative to that anchor. The anchor is the single
...
/// </summary>
public sealed partial class ClassicZGridSyncSystem : VirtualController
{
    [Dependency] private SharedTransformSystem _transform = default!;
    [Dependency] private ClassicZLevelsSystem _zlevels = default!;
    [Dependency] private ClassicZGridConnectorSystem _connectorSystem = default!;

    [Dependency] private EntityQuery<ClassicZGridComponent> _gridCompQuery = default!;
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ClassicZGridComponent, ClassicGridAddedIntoZNetworkEvent>(OnGridLinked);
        SubscribeLocalEvent<ClassicZGridComponent, ClassicGridRemovedFromZNetworkEvent>(OnGridUnlinked);

        SubscribeLocalEvent<ClassicZGridComponent, MoveEvent>(OnGridMoved);
        SubscribeLocalEvent<ClassicZGridComponent, MassDataChangedEvent>(OnMassChanged);
    }

    private void OnGridLinked(Entity<ClassicZGridComponent> zGridEnt, ref ClassicGridAddedIntoZNetworkEvent ev)
    {
    ...
    private void OnGridUnlinked(Entity<ClassicZGridComponent> ent, ref ClassicGridRemovedFromZNetworkEvent ev)
    {
    ...
    private void OnGridMoved(Entity<ClassicZGridComponent> ent, ref MoveEvent ev)
    {
    ...
    private void OnMassChanged(Entity<ClassicZGridComponent> ent, ref MassDataChangedEvent args)
    {
    ...
    private void ApplyAnchorToGrid(EntityUid gridUid, ClassicZGridComponent comp, Vector2 anchorPos, Angle anchorRot)
    {
    ...
    private EntityUid ChooseAnchor(ClassicZGridNetworkComponent net)
    {
    ...
    private bool HasValidAnchor(ClassicZGridNetworkComponent net)
    {
    ...
    private void EnsureAnchor(ClassicZGridNetworkComponent net)
    {
    ...
    /// </summary>
    private void RebaseToAnchor(ClassicZGridNetworkComponent net, EntityUid newAnchor)
    {
    ...
    private void RecalculateNetworkCache(Entity<ClassicZGridNetworkComponent> network)
    {
        var totalMass = 0f;
        var hasStatic = false;
    ...
    private void SnapNewGridToAnchor(ClassicZGridNetworkComponent net, Entity<ClassicZGridComponent> grid)
    {
    ...
    private void RunRigidBodyConsensus(ClassicZGridNetworkComponent net)
    {
    ...
    public override void UpdateBeforeSolve(bool prediction, float frameTime)
    {
        ...
        var netEnum = EntityQueryEnumerator<ClassicZGridNetworkComponent>();
    ...
    private void CorrectFlyingNetwork(ClassicZGridNetworkComponent net)
    {
        RunRigidBodyConsensus(net);
