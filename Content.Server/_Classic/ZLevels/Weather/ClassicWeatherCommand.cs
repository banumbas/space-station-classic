...
using Content.Shared._Classic.ZLevels.Weather;
...
namespace Content.Server._Classic.ZLevels.Weather;

[AdminCommand(AdminFlags.Fun)]
public sealed partial class ClassicWeatherCommand : LocalizedCommands
{
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        if (!_entities.TryGetComponent<ClassicZMapNetworkComponent>(target, out var levelComp))
        {
        ...
        _entities.System<ClassicWeatherSystem>().SetWeather((target.Value, levelComp), weatherProto, duration);
    }
