...
namespace Content.Server._Classic.ZLevels.Chat;

public sealed partial class ClassicZLevelsSpeakingSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ClassicZLevelViewerComponent, EntitySpokeEvent>(OnSpoke);
    }

    private void OnSpoke(Entity<ClassicZLevelViewerComponent> ent, ref EntitySpokeEvent args)
    {
