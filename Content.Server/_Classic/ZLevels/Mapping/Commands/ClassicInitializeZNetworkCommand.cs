...
public sealed partial class ClassicInitializeZNetworkCommand : LocalizedEntityCommands
{
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        {
            shell.WriteError($"Target entity doesnt have ClassicZLevelsNetworkComponent {args[1]}");
            return;
        }
