...
public sealed partial class ClassicAddMapAboveZNetworkCommand : LocalizedEntityCommands
{
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        {
            shell.WriteError($"Target entity doesn't have ClassicZLevelsNetworkComponent {args[0]}");
            return;
        }
