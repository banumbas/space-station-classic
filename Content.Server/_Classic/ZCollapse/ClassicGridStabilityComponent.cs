...
/// always fully replaced by <see cref="ClassicZCollapseSystem"/> from a fresh flood-fill, never patched
/// incrementally. There is deliberately no separate seed cache to desync.
/// </summary>
[RegisterComponent]
public sealed partial class ClassicGridStabilityComponent : Component
{
    /// <summary>
    ...
    /// <summary>Currently anchored <see cref="ClassicGridStabilityCoreComponent"/> entities on this grid.</summary>
    [ViewVariables]
    public readonly HashSet<EntityUid> Cores = new();

    /// <summary>Currently anchored <see cref="ClassicGridStabilitySupportComponent"/> entities on this grid.</summary>
    [ViewVariables]
    ...
    /// delay before <see cref="ClassicZCollapseSystem.CollapseTile"/> steps them down a turf layer. A tile
