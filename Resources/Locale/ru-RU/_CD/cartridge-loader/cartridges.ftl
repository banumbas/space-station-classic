...
nano-chat-message-too-long = Сообщение слишком длинное (символов: {$current}/{$max})
...
nano-chat-look-up-no-server = Доступный телекоммуникационный сервер не найден
nano-chat-look-up = Поиск номеров
nano-chat-list-number = Номер в списке
# Create chat popup
...
# LogProbe additions
log-probe-scan-nanochat = Просканированы журналы NanoChat {$card}.
...
log-probe-recipients = Получатели ({$count})
