...
cd-character-records-viewer-view-entry = Вид
...
cd-character-records-viewer-security-current-shift-label = Текущий журнал смен
cd-character-records-viewer-security-current-shift-empty = Нет текущих записей о сменах.
