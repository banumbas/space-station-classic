...
marking-SlimeTailGooeyDragon = Липкий дракон
marking-SlimeTailGummyCat = Мармеладный кот
marking-SlimeTailHoppingSlime = Прыгающая слизь
marking-SlimeTailNudibranchi = Голожаберные
marking-SlimeTailVulpish = Вульпийский
marking-SlimeTailSquishyFox = Мягкая лиса
marking-SlimeTailWaggableMass = Виляющая масса
marking-SlimeTailWaggableMassWag = Виляющая масса (виляние)

marking-SlimeEarsFoxlike = лисий
marking-SlimeEarsBlades = Лезвия
marking-SlimeEarsBunks = Койки
marking-SlimeEarsCarblunkle = Карбланкл
marking-SlimeEarsHoppers = Хопперы
