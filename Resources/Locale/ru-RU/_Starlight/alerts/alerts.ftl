...
alerts-cybernetic-disruption-desc = Вы [color=red]сорваны[/color]! Что-то повреждает ваши кибернетические имплантаты.
...
alerts-wrapped-name = [color=lightblue]Завершено[/color]
alerts-wrapped-desc = Вы [color=red]запутались[/color]! Нажмите на предупреждение, чтобы попытаться развернуться.
alerts-zoomies-name = [color=lightblue]Зумы!![/color]
alerts-zoomies-desc = У вас увеличена скорость передвижения [color=red]за счет увеличения истощения жажды[/color]
