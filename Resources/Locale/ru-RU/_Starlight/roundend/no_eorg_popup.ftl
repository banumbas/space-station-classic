...
no-eorg-popup-message = [bold]Горе в конце раунда (EORG)[/bold] не разрешено на Moonlight. Пожалуйста, оставайтесь в образе, пока не появится экран вестибюля, который обеспечит погружение в атмосферу для всех. Спасибо за соблюдение правил сообщества!
