...
thaven-mood-plant-pacifist-name = Растение Пацифист
thaven-mood-plant-pacifist-desc = Использование растительных веществ гуманоидами отвратительно.

thaven-mood-puddle-drinker-name = Пьющий лужу
...
thaven-mood-extreme-department-disapproval-desc = {$department} — это не просто иностранная концепция — сама идея этого ужасна.
...
thaven-mood-silicons-must-be-used-desc = Заниматься трудом — это устарело и отвратительно. Всю сложную работу должен выполнять кремний, для этого они и созданы.

thaven-mood-fish-ancestry-name = Рыбное происхождение
...
DuplicateTest = ДубликаттестFTL
DuplicateOverlapTest = ДубликатOverlapTestFTL
