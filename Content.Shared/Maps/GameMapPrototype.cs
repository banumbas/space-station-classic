...
public sealed partial class GameMapPrototype : IPrototype
{
    ...
    [DataField]
    public float MaxRandomOffset = 0; //Classic - we dont need offset because zlevels stacking dont support it
    ...
    [DataField]
    public bool RandomRotation = false; //Classic - we dont need rotate because zlevels stacking dont support it
