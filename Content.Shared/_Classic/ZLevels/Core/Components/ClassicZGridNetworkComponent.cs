...
/// Always reconstructed by <see cref="ClassicZGridConnectorSystem"/> — not persisted.
/// </summary>
[RegisterComponent, NetworkedComponent, AutoGenerateComponentState]
public sealed partial class ClassicZGridNetworkComponent : Component
{
    ...
    /// Its own <see cref="ClassicZGridComponent.NetworkOffset"/>/<see cref="ClassicZGridComponent.NetworkRotation"/> are zero.
    /// </summary>
    [ViewVariables]
