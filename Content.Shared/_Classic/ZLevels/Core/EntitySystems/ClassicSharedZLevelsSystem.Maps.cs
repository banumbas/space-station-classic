...
public abstract partial class ClassicSharedZLevelsSystem
{
    ...
    /// </summary>
    [PublicAPI]
    public bool TryGetMapNetwork(EntityUid mapUid, out Entity<ClassicZMapNetworkComponent> zLevel)
    {
        zLevel = default;
    ...
    [PublicAPI]
    public bool TryMapOffset(Entity<ClassicZMapComponent?> entity, int offset, out Entity<ClassicZMapComponent> output)
    {
        return TryMapOffset(entity, offset, out output, out _);
    }

    [PublicAPI]
    public bool TryMapOffset(Entity<ClassicZMapComponent?> entity, int offset, out Entity<ClassicZMapComponent> output, [NotNullWhen(true)] out MapComponent? mapComponent)
    {
        output = default;
        mapComponent = null;
    ...
    [PublicAPI]
    public bool TryMapUp(Entity<ClassicZMapComponent?> inputMapUid, out Entity<ClassicZMapComponent> aboveMapUid) =>
        TryMapOffset(inputMapUid, 1, out aboveMapUid);

    [PublicAPI]
    public bool TryMapDown(Entity<ClassicZMapComponent?> inputMapUid, out Entity<ClassicZMapComponent> belowMapUid) =>
    ...
    /// </summary>
    [PublicAPI]
    public List<EntityUid> GetAllMapsAbove(Entity<ClassicZMapComponent> entity)
    {
    ...
    /// </summary>
    [PublicAPI]
    public void GetAllMapsAbove(Entity<ClassicZMapComponent> entity, List<EntityUid> result)
    {
        result.Clear();
    ...
    /// </summary>
    [PublicAPI]
    public List<EntityUid> GetAllMapsBelow(Entity<ClassicZMapComponent> entity)
    {
    ...
    private Entity<ClassicZMapComponent>? MapOffset(Entity<ClassicZMapComponent?> entity, int offset)
    {
