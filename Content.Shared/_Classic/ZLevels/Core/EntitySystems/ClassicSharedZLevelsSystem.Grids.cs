...
public abstract partial class ClassicSharedZLevelsSystem
{
    ...
    /// <summary>
    /// Cache-first lookup: checks <see cref="ClassicZGridComponent.Network"/> first,
    /// falls back to a NetworkId string scan and updates the cache on a miss.
    /// </summary>
    [PublicAPI]
    public bool TryGetGridNetwork(EntityUid grid, out Entity<ClassicZGridNetworkComponent> network)
    {
        network = default;
        ...
        var q = EntityQueryEnumerator<ClassicZGridNetworkComponent>();
...
/// </summary>
public sealed class ClassicZLevelGridNetworkUpdatedEvent : EntityEventArgs;

/// <summary>
/// Raised at a grid entity when it is added to a z-grid network by <see cref="ClassicZGridConnectorSystem"/>.
/// </summary>
[ByRefEvent]
public readonly struct ClassicGridAddedIntoZNetworkEvent(Entity<ClassicZGridNetworkComponent> network)
{
    public readonly Entity<ClassicZGridNetworkComponent> Network = network;
}
...
/// </summary>
[ByRefEvent]
public readonly struct ClassicGridRemovedFromZNetworkEvent(Entity<ClassicZGridNetworkComponent> network)
{
    public readonly Entity<ClassicZGridNetworkComponent> Network = network;
}
