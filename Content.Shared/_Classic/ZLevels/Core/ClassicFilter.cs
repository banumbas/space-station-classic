...
public static class ClassicFilter
{
    ...
    public static Filter ZPvsExcept(EntityUid origin, IEntityManager? entManager = null)
    {
        ...
        var zSystem = entManager.System<ClassicSharedZLevelsSystem>();
        ...
        for (var i = 1; i <= ClassicSharedZLevelsSystem.MaxZLevelsBelowRendering; i++)
        {
