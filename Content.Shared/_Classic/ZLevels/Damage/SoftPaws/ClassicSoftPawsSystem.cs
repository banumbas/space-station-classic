...
namespace Content.Shared._Classic.ZLevels.Damage.SoftPaws;

public sealed partial class ClassicSoftPawsSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ClassicSoftPawsComponent, ClassicZFallingDamageCalculateEvent>(OnFallingDamageCalculate);
    }

    private void OnFallingDamageCalculate(Entity<ClassicSoftPawsComponent> ent, ref ClassicZFallingDamageCalculateEvent args)
    {
