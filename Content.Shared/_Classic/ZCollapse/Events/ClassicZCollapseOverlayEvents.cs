...
namespace Content.Shared._Classic.ZCollapse.Events;

/// <summary>
/// Raised when the server enables/disables the tile-stability debug overlay for a client.
/// After enabling, the client starts receiving <see cref="ClassicZCollapseOverlaySnapshotEvent"/>.
/// </summary>
[Serializable, NetSerializable]
public sealed class ClassicZCollapseOverlayToggledEvent(bool isEnabled) : EntityEventArgs
{
...
/// </summary>
[Serializable, NetSerializable]
public sealed class ClassicZCollapseOverlaySnapshotEvent(Dictionary<NetEntity, Dictionary<Vector2i, int>> grids) : EntityEventArgs
{
    /// <summary>
