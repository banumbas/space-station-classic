...
public sealed partial class VehicleSupplyLiftComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier? LoweringSound = new SoundPathSpecifier("/Audio/_Classic/Machines/asrs_lowering.ogg");

    [DataField]
    public SoundSpecifier? RaisingSound = new SoundPathSpecifier("/Audio/_Classic/Machines/asrs_raising.ogg");
