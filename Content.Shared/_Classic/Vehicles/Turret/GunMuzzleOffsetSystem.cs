...
[ByRefEvent]
public record struct VehicleBeforeMuzzleFlashEvent(EntityUid Weapon, Vector2 Offset = default)
{
...
public sealed class GunMuzzleOffsetSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<GunMuzzleOffsetComponent, VehicleBeforeMuzzleFlashEvent>(OnBeforeMuzzleFlash);
    }
    ...
    private void OnBeforeMuzzleFlash(Entity<GunMuzzleOffsetComponent> ent, ref VehicleBeforeMuzzleFlashEvent args)
    {
