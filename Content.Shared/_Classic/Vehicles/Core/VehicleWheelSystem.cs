...
public sealed class VehicleWheelSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<VehicleWheelSlotsComponent, ClassicVehicleCanRunEvent>(OnVehicleCanRun);
    }
    ...
    private void OnVehicleCanRun(Entity<VehicleWheelSlotsComponent> ent, ref ClassicVehicleCanRunEvent args)
    {
        if (!args.CanRun)
            return;
