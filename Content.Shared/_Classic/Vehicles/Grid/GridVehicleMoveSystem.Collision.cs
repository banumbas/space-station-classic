...
public sealed partial class GridVehicleMoverSystem : EntitySystem
{
        ...
        HashSet<EntityUid>? ignoredEntities = null)
    {
        ...
        if (TryComp<ClassicVehicleComponent>(uid, out var vehicleComp))
        ...
        out CollisionCandidate candidate)
    {
        ...
        var isVehicle = HasComp<ClassicVehicleComponent>(other);
        ...
        bool applyEffects)
    {
        ...
        if (!TryComp(pushed, out ClassicVehicleComponent? pushedVehicle) ||
            pushedVehicle.MovementKind != ClassicVehicleMovementKind.Grid)
        {
            return false;
        }
    ...
    private void SmashTarget(EntityUid target, EntityUid vehicle, VehicleSmashableComponent smashable)
    {
        ...
        _damageable.TryChangeDamage(target, damage, true, origin: vehicle);
        ...
        out EntityUid blocker)
    {
        ...
        foreach (var ent in _intersecting)
        {
            ...
            var isVehicle = HasComp<ClassicVehicleComponent>(ent);
